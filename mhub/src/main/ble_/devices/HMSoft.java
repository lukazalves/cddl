...
public class HMSoft implements TechnologyDevice {
    ...
    public enum Sensor implements TechnologySensor {
        IR_SENSOR("HMSoft", UUID_LAB_SERV, UUID_SEN_DATA, null) {
            @Override
        ...
        private static final int SENSOR_VALUES = 1;
        ...
        public Double[] parse(final byte[] value) {
            ...
            for (int i = 0; i < token.length; i++) {
                arr[i] = Double.parseDouble(token[i]);
            }
            return arr;
        }
