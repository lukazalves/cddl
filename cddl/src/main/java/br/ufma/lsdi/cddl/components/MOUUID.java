...
public class MOUUID {
    ...
    public MOUUID(int TechnologyID, String mObjectAddress) {
        ...
        this.mObjectAddress = mObjectAddress;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof br.pucrio.inf.lac.mhub.components.MOUUID))
            return false;

        if (other == this)
            return true;

        br.pucrio.inf.lac.mhub.components.MOUUID temp = (br.pucrio.inf.lac.mhub.components.MOUUID) other;
